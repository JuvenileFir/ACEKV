...
def draw_insert_new(idx):
    ...
    colors = ["red","blue","tab:red","tab:orange","tab:purple","tab:blue","tab:green","tab:gray"]
    ...
    elif xy_limit[axtype[0]] == 140:
        x_ticks = np.linspace(0,xy_limit[axtype[0]],8)
    xy_name = [ ['0','20','40','60','80','100','120','140'],
