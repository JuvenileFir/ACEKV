...
wratios=(100 120)
# logsizes=(30 31)
logsizes=(30 31) # 33 34 35-256 36
hashsizes=(23) 
#ghr用单线程memc3的hashsize = 23 logsize = 31 (1:1)
#tput用4线程memc3的hashsize = 25 logsize = 33 (1:1)
kvsize=8
###在server端运行，然后将参数传递到client端
    ...
    # fi
        ...
        # nohup sudo -S sudo ./main -f 2 -l $logsize -t $hashsize > ../data/${time1}c${zu}_h${hashsize}l${logsize}_${wratio}ghr.log 2>&1 &
        nohup sudo -S sudo ./main -f 2 -l $logsize -t $hashsize > ../data/${time1}c${zu}_h${hashsize}l${logsize}x.666_${wratio}ghr.log 2>&1 &
